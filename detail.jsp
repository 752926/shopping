		...
		<div class="am-container header">
			...
			<ul class="message-r">
				...
				<div class="topMessage mini-cart">
					<div class="menu-hd"><a id="mc-menu-hd" href="./cart.jsp" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
				</div>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								...
								<a href="images/01.jpg"><img src="images/small-<%= p.getImg() %>" alt="细节展示放大镜特效" rel="images/large-<%= p.getImg() %>" class="jqzoom" /></a>
